...
#define TFT_PNG_BOOT      "/qEdgeBootScreen.png"       // Boot screen
#define TFT_PNG_MENU      "/HwTestAppMenueScreen.png"  // Menu screen
#define TFT_PNG_WALL      "/qEdgeWallpaperScreen.png"  // Wallpaper
#define TFT_PNG_IDLE      "/qEdgeIdleScreen.png"       // Idle screen
