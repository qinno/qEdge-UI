...
#if defined(PICO_RP2350) && defined(PICO_CYW43_SUPPORTED)
#define PF_NAME "qEdge-PICO2-W"
#include <WiFi.h>
#warning PICO2-W
#define WIFI_AVAILABLE
#elif defined(PICO_RP2040) && defined(PICO_CYW43_SUPPORTED)
#define PF_NAME "qEdge-PICO-W"
#include <WiFi.h>
#warning PICO-W
#define WIFI_AVAILABLE
#elif defined(PICO_RP2350)
#warning PICO2
#define PF_NAME "qEdge-PICO2"
#else
#warning PICO
#define PF_NAME "qEdge-PICO"
#endif
...
#define PICO_LED  LED_BUILTIN  // LED
#define PICO_USB  24  // USB present if HIGH
//#define PICO_SMPS 23  // SMPS control HIGH = PWM mode else PFM (low power) // not valid for W
